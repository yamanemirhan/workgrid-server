...
public class NotificationRepository(NotificationDbContext _notificationContext, AppDbContext _appContext) : INotificationRepository
{
    ...
    {
        var unreadNotifications = await _notificationContext.Notifications
            .Where(n => n.UserId == userId && !n.IsRead)
            .ToListAsync();
